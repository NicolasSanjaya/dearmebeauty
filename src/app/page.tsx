...
export default function Home() {
  return (
    <div>
      <Circle className="absolute -top-12 -left-12 -z-10" />
      <Navbar />
      {/* Section Hero */}
      <section className=" w-full flex bg-gradient-to-t from-softpink to-softwhite">
      ...
      <section className="flex relative overflow-hidden">
        ...
        <div className="w-1/2 flex flex-col items-start justify-center p-12 gap-6">
        ...
        <Circle className="absolute bottom-6 opacity-30 blur-xl -right-20 -z-10 w-[500px] h-[500px]" />
      </section>
